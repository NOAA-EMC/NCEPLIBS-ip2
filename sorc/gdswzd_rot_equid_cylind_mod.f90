 ...
 IF(IOPT.EQ.0.OR.IOPT.EQ.1) THEN
   DO N=1,NPTS
     IF(XPTS(N).GE.XMIN.AND.XPTS(N).LE.XMAX.AND. &
       ...
       IF(LAREA) CALL ROT_EQUID_CYLIND_GRID_AREA(FILL, AREA(N))
     ELSE
       RLON(N)=FILL
       RLAT(N)=FILL
     ENDIF
...
!
 SUBROUTINE ROT_EQUID_CYLIND_VECT_ROT(RLON, CROT, SROT)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
...
!
! USAGE:    CALL ROT_EQUID_CYLIND_VECT_ROT(RLON, CROT, SROT)
!
!   INPUT ARGUMENT LIST:
...
!
! USAGE:  CALL ROT_EQUID_CYLIND_MAP_JACOB(FILL,RLON,XLON,XLAT,YLON,YLAT)
!
!   INPUT ARGUMENT LIST:
...
!
 SUBROUTINE ROT_EQUID_CYLIND_GRID_AREA(FILL, AREA)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
...
!
! USAGE:  CALL ROT_EQUID_CYLIND_GRID_AREA(FILL,AREA)
!
!   INPUT ARGUMENT LIST:
!     FILL     - FILL VALUE FOR UNDEFINED POINTS (REAL)
!
