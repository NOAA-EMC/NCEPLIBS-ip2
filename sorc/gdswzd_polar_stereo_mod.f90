     ...
     DO N=1,NPTS
       IF(XPTS(N).GE.XMIN.AND.XPTS(N).LE.XMAX.AND. &
         ...
         ENDIF
           ...
           IF(LAREA) CALL POLAR_STEREO_GRID_AREA(RLAT(N),AREA(N))
       ELSE
         RLON(N)=FILL
         RLAT(N)=FILL
       ENDIF
...
!
 SUBROUTINE POLAR_STEREO_MAP_JACOB(RLON,RLAT,XLON,XLAT,YLON,YLAT)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
...
!
! USAGE:  CALL POLAR_STEREO_MAP_JACOB(RLON,RLAT,XLON,XLAT,YLON,YLAT)
!
!   INPUT ARGUMENT LIST:
...
!
 SUBROUTINE POLAR_STEREO_GRID_AREA(RLAT, AREA)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
