module polates6_mod
  ...
  interface polates6
     module procedure polates6_grib1
     module procedure polates6_grib2
  end interface polates6

contains

  SUBROUTINE POLATES6_grib2(IPOPT,IGDTNUMI,IGDTMPLI,IGDTLENI, &
  ...
  !! -  POLFIXS      MAKE MULTIPLE POLE SCALAR VALUES CONSISTENT
  !!
  SUBROUTINE POLATES6_grib1(IPOPT,KGDSI,KGDSO,MI,MO,KM,IBI,LI,GI, &
       NO,RLAT,RLON,IBO,LO,GO,IRET)
    INTEGER,    INTENT(IN   ) :: IBI(KM), IPOPT(20), KM, MI, MO
