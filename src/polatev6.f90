module polatev6_mod
  ...
  interface polatev6
     module procedure polatev6_grib1
     module procedure polatev6_grib2
  end interface polatev6

contains

  SUBROUTINE POLATEV6_grib2(IPOPT,IGDTNUMI,IGDTMPLI,IGDTLENI, &
  ...
  !! -  POLFIXV      MAKE MULTIPLE POLE VECTOR VALUES CONSISTENT
  !!
  SUBROUTINE POLATEV6_grib1(IPOPT,KGDSI,KGDSO,MI,MO,KM,IBI,LI,UI,VI, &
       NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
    INTEGER,         INTENT(IN   ):: IPOPT(20), IBI(KM)
    INTEGER,         INTENT(IN   ):: KM, MI, MO
