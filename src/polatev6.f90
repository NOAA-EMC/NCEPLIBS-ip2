...
contains
  ...
  SUBROUTINE POLATEV6(IPOPT, input_desc, output_desc, &
    ...
    ELSE
       IRET=31
    ENDIF
    CALL CHECK_GRIDS6V(input_desc, output_desc, SAME_GRIDI, SAME_GRIDO)
  ...
  !
  SUBROUTINE CHECK_GRIDS6V(input_desc, output_desc, SAME_GRIDI, SAME_GRIDO)
    !$$$  SUBPROGRAM DOCUMENTATION BLOCK
    !
