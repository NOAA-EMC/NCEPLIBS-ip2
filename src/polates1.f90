module polates1_mod
  ...
  interface polates1
     module procedure polates1_grib1
     module procedure polates1_grib2
  end interface polates1

contains

  SUBROUTINE POLATES1_grib2(IPOPT,IGDTNUMI,IGDTMPLI,IGDTLENI, &
  ...
  !> @file
  !! INTERPOLATE SCALAR FIELDS (BICUBIC)
