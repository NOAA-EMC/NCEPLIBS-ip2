...
contains
  ...
  SUBROUTINE POLATEV2(IPOPT, input_desc, output_desc, &
    ...
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    CALL CHECK_GRIDS2V(input_desc, output_desc,SAME_GRIDI,SAME_GRIDO)
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  SUBROUTINE CHECK_GRIDS2V(input_desc, output_desc, SAME_GRIDI, SAME_GRIDO)
    !$$$  SUBPROGRAM DOCUMENTATION BLOCK
    !
