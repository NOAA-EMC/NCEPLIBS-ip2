...
contains
  SUBROUTINE POLATEV1(IPOPT,input_desc, output_desc, &
    ...
    PMP=MP*0.01
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    CALL CHECK_GRIDS1V(input_desc, output_desc, SAME_GRIDI,SAME_GRIDO)
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    IF(IRET.EQ.0.AND.(output_desc%grid_number.LT.0.OR..NOT.SAME_GRIDI.OR..NOT.SAME_GRIDO))THEN
       ...
       CALL GDSWZD(input_desc, 0,MI,FILL,XPTI,YPTI,RLOI,RLAI, &
            NV,CROI,SROI)
       ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  SUBROUTINE CHECK_GRIDS1V(input_desc, output_desc, SAME_GRIDI, SAME_GRIDO)
    !$$$  SUBPROGRAM DOCUMENTATION BLOCK
    !
