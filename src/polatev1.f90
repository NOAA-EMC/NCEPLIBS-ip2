module polatev1_mod
  ...
  ! interface polatev1
  !    module procedure polatev1_grib1
  !    module procedure polatev1_grib2
  ! end interface polatev1
...
contains
  ...
  SUBROUTINE POLATEV1_grib2(IPOPT,IGDTNUMI,IGDTMPLI,IGDTLENI, &
       IGDTNUMO,IGDTMPLO,IGDTLENO, &
       MI,MO,KM,IBI,LI,UI,VI, &
       NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
    !$$$  SUBPROGRAM DOCUMENTATION BLOCK
    ...
    PMP=MP*0.01
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    CALL CHECK_GRIDS1V(IGDTNUMI,IGDTMPLI,IGDTLENI, &
         IGDTNUMO,IGDTMPLO,IGDTLENO, &
  ...
  !   !$$$  SUBPROGRAM DOCUMENTATION BLOCK
  !   !
  !   ! SUBPROGRAM:  CHECK_GRIDS1V   CHECK GRID INFORMATION
  ...
  !   !
  !   ! USAGE:  CALL CHECK_GRIDS1V(IGDTNUMI,IGDTMPLI,IGDTLENI, &
  !   !                            IGDTNUMO,IGDTMPLO, &
  ...
  ! !> @file
  ! !! INTERPOLATE VECTOR FIELDS (BICUBIC)
  ...
  ! !! -  POLFIXV      MAKE MULTIPLE POLE VECTOR VALUES CONSISTENT
  ! !!
  ! SUBROUTINE POLATEV1_grib1(IPOPT,KGDSI,KGDSO,MI,MO,KM,IBI,LI,UI,VI, &
  !      NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
