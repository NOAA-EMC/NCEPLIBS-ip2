...
contains
  ...
  SUBROUTINE POLATES2(IPOPT,input_desc,output_desc,MI,MO,KM,&
    ...
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    CALL CHECK_GRIDS2(input_desc, output_desc, SAME_GRIDI, SAME_GRIDO) 
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  !
  SUBROUTINE CHECK_GRIDS2(input_grid, output_grid, &
