...
contains
  ...
  SUBROUTINE IPOLATEV(IP,IPOPT,IGDTNUMI,IGDTMPLI,IGDTLENI, &
    ...
    IF(IP.EQ.0) THEN
       CALL POLATEV0(IPOPT, g2_input_desc, g2_output_desc, &
            MI,MO,KM,IBI,LI,UI,VI,&
            NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
       ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
       !  BICUBIC INTERPOLATION
    ELSEIF(IP.EQ.1) THEN
       CALL POLATEV1(IPOPT, g2_input_desc, g2_output_desc, &
            MI,MO,KM,IBI,LI,UI,VI,&
            NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
       ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
       !  NEIGHBOR INTERPOLATION
    ELSEIF(IP.EQ.2) THEN
       CALL POLATEV2(IPOPT, g2_input_desc, g2_output_desc, &
            MI,MO,KM,IBI,LI,UI,VI,&
            NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
       ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
       !  BUDGET INTERPOLATION
    ELSEIF(IP.EQ.3) THEN
       CALL POLATEV3(IPOPT, g2_input_desc, g2_output_desc, &
            MI,MO,KM,IBI,LI,UI,VI,&
            NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
       ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
       !  SPECTRAL INTERPOLATION
    ELSEIF(IP.EQ.4) THEN
       CALL POLATEV4(IPOPT, g2_input_desc, g2_output_desc, &
            MI,MO,KM,IBI,UI,VI,&
            NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
       ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
       !  NEIGHBOR-BUDGET INTERPOLATION
    ELSEIF(IP.EQ.6) THEN
       CALL POLATEV6(IPOPT, g2_input_desc, g2_output_desc, &
            MI,MO,KM,IBI,LI,UI,VI,&
            NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
       ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
