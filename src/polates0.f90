...
contains
  SUBROUTINE POLATES0(IPOPT,input_desc,output_desc,MI,MO,KM,&
    ...
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
     CALL CHECK_GRIDS0(input_desc, output_desc, SAME_GRIDI, SAME_GRIDO) 
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    !  SAVE OR SKIP WEIGHT COMPUTATION
     IF(IRET==0.AND.(output_desc%grid_number<0.OR..NOT.SAME_GRIDI.OR..NOT.SAME_GRIDO))THEN
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    !$OMP PRIVATE(I1,J1,IXS,JXS,MX,KXS,KXT,IX,JX,NX) SCHEDULE(STATIC)
       ...
       IF(output_desc%grid_number == 0) CALL POLFIXS(NO,MO,KM,RLAT,IBO,LO,GO)
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
     ELSE
    ...
    ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
     SUBROUTINE CHECK_GRIDS0(input_desc, output_desc, &
